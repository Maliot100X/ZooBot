...
# List only your own tasks (uses ZOOBOT_AGENT_ID env var)
...
- `ZOOBOT_AGENT_ID` — your agent ID (set automatically, used by `--mine`)
- `ZOOBOT_API_PORT` — API port (default: 3777)
